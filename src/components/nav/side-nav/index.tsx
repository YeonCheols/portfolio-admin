...
export default function SideNav() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed bottom-0 left-0 top-0 z-30 flex h-[100dvh] w-44 shrink-0 flex-col border-r border-border bg-gray-50 dark:bg-gray-800 tablet:sticky tablet:translate-x-0',
          'transition-transform duration-300 ease-in-out',
